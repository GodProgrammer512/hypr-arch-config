...
alias upsys='sudo pacman -Syyuu && yay -Syyu && flatpak update && hyprpm update'
alias clean='sudo rm -fr /tmp/*'
alias pacinstall='sudo pacman -Syyuu'
alias pacremove='sudo pacman -Rcs'
alias yayinstall='yay -Syyu'
alias yayremove='yay -Rcs'
...
# Terminals:
# PS1='\033[32m┌──(\033[34m\u\h\033[32m)─[\033[m\033[1m\w\033[m\033[32m]\n\033[32m└─\033[34m$\033[m ' # Kali type, Tux icon..
PS1='\033[32m┌──(\033[34m\u\h\033[32m)─[\033[m\033[1m\w\033[m\033[32m]\n\033[32m└─\033[34m$\033[m ' # Kali type, Arch icon.
